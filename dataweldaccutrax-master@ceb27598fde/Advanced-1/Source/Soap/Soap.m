...
////	NSMutableURLRequest* request = [NSMutableURLRequest requestWithURL: url];
////    
////    //NSData* dataNS=[data_function dataUsingEncoding:NSUTF8StringEncoding];
////    
//////    
...
//////        completionHandler:^(NSData * _Nullable data_function, NSURLResponse * _Nullable response, NSError * _Nullable error) {
////        completionHandler:^(NSData * _Nullable data_function, NSURLResponse * _Nullable response, NSError * _Nullable error) {
////
//////        
//////            NSError *myError;
...
//////             [NSArray alloc]
//////             initWithArray:
//////             [NSJSONSerialization JSONObjectWithData:data_function options:kNilOptions error:&myError]
//////             ];
////            
////            
////            if(action != nil){
